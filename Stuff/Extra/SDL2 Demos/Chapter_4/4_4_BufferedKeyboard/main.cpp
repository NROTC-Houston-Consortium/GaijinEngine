...
int main(int argc, char* args[])
{
    ...
    Window = SDL_CreateWindow("This where things get interesting",
    ...
    while(ProgramIsRunning())
    {
        ...
        //SDL_GetKeyState is gone in SDL 2, replace with SDL_GetKeyboardState
        Uint8* keys = (Uint8*)SDL_GetKeyboardState(NULL);

        //In SDL 2, use SDL_SCACNODE_(KEY) instead of SDLK_(KEY)
        //for the array returned by SDL_GetKeyboardState
